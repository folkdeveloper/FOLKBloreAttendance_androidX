...
String fgNum,timeNu, selected_area;
    String temp;
    Bundle bundle;
    String message,year_fb="4",name,fid,fg,ws,time, mjp, fl, mob, reading;
    int counter;
    int a = -1,bb;
...
//    private CollectionReference attendanceDemo = db.collection("AttendanceDemo");
...
//        pd.setCancelable(true);
        ...
        reading = bundle.getString("selected_read");
...
//                    mName.child("Zread").setValue(reading);
...
//                    String zzcolor = color();




//                    Attendance attendance = new Attendance(selected_area,fg,fid,mjp,name,"FOLK Program",fl,"SRRD", strDate,"ISKCON Bangalore",mob,reading, strTime, zzcolor);
                    Log.d("FOLK", "onClick: area"+selected_area);
//                    attendanceDemo.add(attendance);

                    myThreadConnected.write(b);
                    Intent i = new Intent(MainActivity.this, PreFetchActivity.class);
